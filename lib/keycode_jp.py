...
class KeycodeJP:
    INTERNATIONAL1 = 0x87 #135 # 0x87 \_ Keyboard International1
    """``\`` and ``_``"""
    INTERNATIONAL2 = 0x88 #136 # 0x88 KANA Keyboard International2
    INTERNATIONAL3 = 0x89 #137 # 0x89 \| Keyboard International3
    """``\`` and ``|``"""
    INTERNATIONAL4 = 0x8A #138 # 0x8A HENK Keyboard International4
    INTERNATIONAL5 = 0x8B #139 # 0x8B MHEN Keyboard International5
